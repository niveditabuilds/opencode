export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models included with Vox Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Vox Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Vox Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Vox Code.",
  ...
  "wsl.onboarding.step.opencode": "Vox Code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Vox Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Vox Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Vox Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Vox Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Vox Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Vox Code",
  "wsl.onboarding.opencodeReadyIn": "Vox Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Vox Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Vox Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Vox Code",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Vox Code.",
  ...
  "toast.update.description": "A new version of Vox Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Vox Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Vox Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Vox Code includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Vox Code",
  ...
  "settings.general.row.appearance.description": "Customise how Vox Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Vox Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Vox Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Vox Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Vox Code.",
